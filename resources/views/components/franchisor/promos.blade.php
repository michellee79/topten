	...
	<table cellspacing="0" cellpadding="8" rules="all" id="gvPromoCodes" style="color:#999999;border-width:0px;width:100%;border-collapse:collapse;">
        <tbody>
            ...
            <tr>
                ...
                <td align="center">
                    <a id="lbViewSignedUpUsers" title="Click to view list of users who has signed up without activating their account" href="/franchise_signedup_users/{{$promo->id}}" style="color:#999999;">{{$promo->totalSignedUp}}</a>
                </td>
                <td align="center">
