...
<head>
    ...
    <script src="/scripts/modal/jquery.modal.min.js" type="text/javascript"></script>
    <link href="/scripts/modal/jquery.modal.min.css" rel="stylesheet" type="text/css" />
            ...
            <li class="submenu">
                <div class="menuText">
                    <a id="linkToChangeLocationMobile" href="Set%20Location" style="color:#999999;text-decoration:none;">
                    	...
                    	<span id="lblCurrentLocationMobile" title="Change Current Location" style="color:#A6832F;font-weight:normal;"></span>
                	</a>
                </div>
            </li>
            <li class="submenu">
