...
function togglePromoNeedActivation(sender, pid){
	showLoading();
	$.ajax({
        url : '/aajax/promo/toggleneedactivation/' + pid,
        type : 'get',
        dataType : 'json',
        success: function(data){
        	hideLoading();
...
function togglePromoActivation(sender, pid){
	showLoading();
	$.ajax({
        url : '/aajax/promo/toggleactivation/' + pid,
        type : 'get',
        dataType : 'json',
        success: function(data){
        	hideLoading();
...
function viewByFranchise(){
	f = $("#ddlFranchiseCode").val();
	$.ajax({
        url : '/aajax/promo/viewByFranchise/' + f,
        type : 'get',
        dataType : 'json',
        success: function(data){
        	location.reload();
